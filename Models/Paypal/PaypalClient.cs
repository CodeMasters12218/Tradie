...
namespace Tradie.Models.Paypal
{
    public class PaypalClient
    {
        ...
        public async Task<CreateOrderResponse> CreateOrder(string value, string currency, string reference)
        {
            ...
            value = decimal.Parse(value, System.Globalization.CultureInfo.GetCultureInfo("es-ES"))
                ...
                purchase_units = new List<PurchaseUnit>
        {
            ...
            {
                throw new Exception("Error: La respuesta de PayPal no contiene un ID de orden válido.");
            }
